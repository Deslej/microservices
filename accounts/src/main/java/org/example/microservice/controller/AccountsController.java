...
import org.example.microservice.dto.ResponseDto;
...
@Tag(
        name = "CRUD REST API for Accounts in EazyBanks",
        description = "CRUD REST APIs in EazyBanks to CREATE,UPDATE,FETCH AND DELET account details"
)
@RestController
...
public class AccountsController {
    ...
    @Operation(
            summary = "Fetch Account & Customer Details REST API",
    ...
    @Operation(
            summary = "Delete Account & Customer detailsREST API",
