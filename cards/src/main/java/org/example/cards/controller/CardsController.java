...
public class CardsController {
    ...
    public ResponseEntity<ResponseDto> createCard(@Valid @RequestParam
        ...
        return ResponseEntity
                ...
                .body(new ResponseDto(CardsConstants.MESSAGE_201, CardsConstants.STATUS_201));
    ...
    public ResponseEntity<ResponseDto> updateCardDetails(@Valid @RequestBody CardsDto cardsDto) {
        ...
        if(isUpdated) {
            ...
            return ResponseEntity
                    ...
                    .body(new ResponseDto(CardsConstants.MESSAGE_417_UPDATE, CardsConstants.STATUS_417));
        }
    }
    @Operation(
    ...
    public ResponseEntity<ResponseDto> deleteCardDetails(@Valid @RequestParam
        ...
        if (isDeleted) {
            return ResponseEntity
                    .status(HttpStatus.OK)
                    .body(new ResponseDto(CardsConstants.STATUS_200,CardsConstants.STATUS_200));
        } else {
            return ResponseEntity
                    .status(HttpStatus.EXPECTATION_FAILED)
